...
public class FtpUtils {
	...
	private static Logger log = LoggerFactory.getLogger(FtpUtils.class);
        ...
        //ftp服务器地址
        public String hostname = "172.16.65.235";
        //ftp服务器端口号默认为21
        public Integer port = 21;
        //ftp登录账号
        public String username = "setcollftp";
        //ftp登录密码
        public String password = "setcollftp!123";
        ...
        * @return */
        public  boolean downloadFile(String pathname, String filename, String localpath){ 
            ...
            try { 
                ...
                if (existHttpPath(pathname) == true) {//判断文件是否存在
                	newname = getnewfilename(pathname);//获取最新文件的名字
        ...
        * @return */ 
         ...
         * 按照时间获取最新文件
         * */
        public String getnewfilename(String pathname) {
        	...
        	if (file.isDirectory()) {
        		...
        		for (int i = 0; i < files.length; i++) {
					modify_time = Integer.parseInt(sdf.format(new Date(files[i].lastModified())));
					if (modify_time > tmp) {
